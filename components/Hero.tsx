    ...
    <section className="relative overflow-hidden px-6 py-20 md:py-28">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-14 md:grid-cols-2 md:items-center">
        ...
        <div className="relative">
          <div className="rounded-[2.8rem] border border-[#D6B88A]/30 bg-white/85 p-4 shadow-2xl shadow-[#0F5B6E]/10 backdrop-blur">
            <div className="relative h-[430px] overflow-hidden rounded-[2.2rem]">
              <Image
                src="/photo.webp"
          ...
          <div className="absolute -bottom-8 -left-4 rounded-[2rem] bg-white/95 p-6 shadow-2xl backdrop-blur md:-left-8">
            <p className="text-sm uppercase tracking-[0.25em] text-[#D6B88A]">
              Ma promesse
            </p>
            <p className="mt-2 max-w-xs text-lg font-semibold text-[#0F5B6E]">
              Une personne de confiance, pas une plateforme impersonnelle.
            </p>
          </div>
